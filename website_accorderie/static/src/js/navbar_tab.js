odoo.define('website.accorderie.navbar_tabs.instance', function (require) {
    'use strict';

    require('web_editor.ready');
    let PublierForm = require('website.accorderie.navbar_tabs');
...
odoo.define("website.accorderie.navbar_tabs", function (require) {
